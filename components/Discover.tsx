...
const Discover = () => {
    ...
    const activeTopicStyle = "xl:border-2 hover:bg-primary xl:border-[#02B290] px-3 py-2 rounded xl:rounded-full flex item-center gap-2 justify-center cursor-pointer text-[#02B290]";
    ...
    return (
        <div className='xl:border-b-2 xl:border-gray-200 pb-6'>
            <p className='test-gray-500 font-semibold m-3 mt-4 hidden xl:block'>Popular Topics</p>

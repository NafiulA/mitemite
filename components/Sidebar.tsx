    ...
    return (
        <div>
            <div className='block xl:hidden m-2 ml-4 mt-3 text-xl' onClick={() => setShowSidebar((prev) => !prev)}>
                {showSidebar ? <ImCancelCircle></ImCancelCircle> : <AiOutlineMenu></AiOutlineMenu>}
            </div>
            {showSidebar && (
                        ...
                        <div className='px-2 py-4 hidden xl:block'>
                            ...
                            <p className='pr-4'>
                                <GoogleLogin
                                    ...
                                    render={(renderProps) => (
                                        <button
                                            className='bg-white text-lg text-[#F51997] border-[1px] border-[#f51997] font-semibold px-6 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-[#f51997] curson-pointer'
